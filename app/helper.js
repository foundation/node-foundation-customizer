...
exports.createCompleteAndEssential=function(){
  ...
  childProcess.execFileSync(process.env.SHELL,['-c', "gulp sass:foundation && gulp javascript:foundation && gulp deploy:custom"], {cwd: '../../f6'})
  childProcess.execFileSync(process.env.SHELL,['-c', "cp ./_build/assets/css/*.css ../node-foundation-customizer/app/assets/temp-complete/css"], {cwd: '../../f6'})
  childProcess.execFileSync(process.env.SHELL,['-c', "cp ./_build/assets/js/*.* ../node-foundation-customizer/app/assets/temp-complete/js"], {cwd: '../../f6'})
  childProcess.execFileSync(process.env.SHELL,['-c', "cp ./bower_components/jquery/dist/jquery.min.js ../node-foundation-customizer/app/assets/temp-complete/js"], {cwd: '../../f6'})
  childProcess.execFileSync(process.env.SHELL,['-c', "cp ./bower_components/jquery/dist/jquery.js ../node-foundation-customizer/app/assets/temp-complete/js"], {cwd: '../../f6'})
