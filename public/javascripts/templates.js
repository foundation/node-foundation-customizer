...
with (obj) {__p += '<li>\n  <div class="building-block-item">\n    <a href="http://zurb.com/building-blocks/' +((__t = ( slug )) == null ? '' : __t) +'">\n    <div>\n      <h4 class="building-block-item-header">' +((__t = ( name )) == null ? '' : __t) +'</h4>\n      <img src="' +((__t = ( image_url )) == null ? '' : __t) +'"/>\n    </div>\n  </div>\n</li>\n';
...
function(obj) {obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {__p += '<!-- Delicious Link Template -->\n<li>\n  <a href="' +((__t = ( u )) == null ? '' : __t) +'">\n    <span class="date">' +((__t = ( formattedDate )) == null ? '' : __t) +'</span>\n    <span class="title">' +((__t = ( d )) == null ? '' : __t) +'</span>\n    <span class="description">' +((__t = ( n )) == null ? '' : __t) +'</span>\n  </a>\n</li>\n';
...
function(obj) {obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {__p += '<div class="row archive-posts bump-25 post-box">\n  <div class="large-10 large-centered columns">\n    <h1 class="title text-center">\n      <a href="' +((__t = ( seo_url )) == null ? '' : __t) +'">' +((__t = ( title )) == null ? '' : __t) +'</a>\n    </h1>\n  </div>\n</div>\n\n<div class="row archive-posts bump-25 post-box">\n  <div class="large-8 large-centered columns">\n    <div class="comment-author-line">\n      <p class="centered-text">\n        <span itemprop="author">' +((__t = ( user )) == null ? '' : __t) +'</span> wrote this.\n        <span itemprop="discussionUrl">It has <a href="' +((__t = ( seo_url )) == null ? '' : __t) +'">' +((__t = ( reactions )) == null ? '' : __t) +' Reactions</a></span>\n      </p>\n    </div>\n    <hr>\n\n    <div class="description">\n      <p class="post-details">\n        ' +((__t = ( description )) == null ? '' : __t) +'\n        ...<span class="continue"><a href="' +((__t = ( seo_url )) == null ? '' : __t) +'">Keep reading</a></span>\n      </p>\n    </div>\n  </div>\n</div>\n\n<div class="row dashed-break">\n  <div class="large-10 columns large-centered">\n    <br>\n    <hr class="dashed">\n    <br>\n  </div>\n</div>\n';
...
function(obj) {obj || (obj = {});
var __t, __p = '', __e = _.escape;
with (obj) {__p += '<li>\n  <div class="lesson-item">\n    <a href="http://zurb.com/university/lessons/' +((__t = ( slug )) == null ? '' : __t) +'">\n      <img src="' +((__t = ( preview_image )) == null ? '' : __t) +'"/>\n      <h5 class="lesson-item-header">' +((__t = ( title )) == null ? '' : __t) +'</h5>\n    </a>\n  </div>\n</li>\n';
